    ...
    if query.data.startswith("file"):
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                caption=f'<b></u>Hai 👋 {query.from_user.mention}</b></u> 😍\n\n<code>[KR.OTT] {title}</code>\n\n⚠️ <i><u>[𝐓𝐡𝐢𝐬 𝐟𝐢𝐥𝐞 𝐰𝐢𝐥𝐥 𝐛𝐞 𝐝𝐞𝐥𝐞𝐭𝐞𝐝 𝐟𝐨𝐫𝐦 𝐡𝐞𝐫𝐞 𝐰𝐢𝐭𝐡 𝐢𝐧 𝟏𝟎 𝐦𝐢𝐧𝐮𝐭𝐞 𝐚𝐬 𝐢𝐭 𝐡𝐚𝐬 𝐜𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭...!!!](https://t.me/c/1555030497/75)</i></u>\n\n<i><b>⚡ Powered by:- {query.message.chat.title}</b></i>\n\n╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╗\n♻️ 𝙅𝙊𝙄𝙉 :- [𝙆𝙞𝙘𝙘𝙝𝙖 𝙊𝙏𝙏](t.me/Kiccha_OTT)\n♻️ 𝙅𝙊𝙄𝙉 :- [𝙆𝙞𝙘𝙘𝙝𝙖 𝙍𝙚𝙦𝙪𝙚𝙨𝙩](t.me/KicchaRequest)\n╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╝\n\n\n♡ ㅤ   ❍ㅤ     ⎙      ⌲\nˡᶦᵏᵉ  ᶜᵒᵐᵐᵉⁿᵗ  ˢᵃᵛᵉ   ˢʰᵃʳᵉ',
                protect_content=True if ident == "filep" else False 
            )
            msg1 = await query.message.reply(
                f'<b><u> Hai 👋 {query.from_user.mention} </b></u>😍\n\n<b>📫 Your File is Ready</b>\n\n'           
                f'<b>📂 Fɪʟᴇ Nᴀᴍᴇ</b> : <code>[KR.OTT] {title}</code>\n\n'              
                f'<b>⚙️ Fɪʟᴇ Sɪᴢᴇ</b> : <b>{size}</b>\n\n'
                f'<b><u>⚠️ 𝙏𝙝𝙞𝙨 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙒𝙞𝙡𝙡 𝘽𝙚 𝘿𝙚𝙡𝙚𝙩𝙚𝙙 𝘼𝙛𝙩𝙚𝙧 𝟏𝟎 𝙈𝙞𝙣𝙪𝙩𝙚𝙨…</u><b>\n\n'
                f'<b>♡ ㅤ   ❍ㅤ     ⎙      ⌲\nˡᶦᵏᵉ  ᶜᵒᵐᵐᵉⁿᵗ  ˢᵃᵛᵉ   ˢʰᵃʳᵉ',
                True,
                'html',
